...
public final class DeploymentVersionUtil {
    ...
    public static boolean versionUpdateNeeded(String newVersion, String storedVersion) {
        ...
        int ver1_tmp = newVersion.indexOf(SUFFIX_SNAPSHOT);
        if (ver1_tmp != -1) {
        ...
        int ver2_tmp = storedVersion.indexOf(SUFFIX_SNAPSHOT);
        if (ver2_tmp != -1) {
